...
const pages = ['Home', 'Content', 'Tags', 'Article'];
...
const Navbar = () => {
  ...
  {
        page === 'Profile' && navigate('/adminprofile')
        page === 'Home' && navigate('/adminhome')
        page === 'Content' && navigate('/adminquestions')
        page === 'Tags' && navigate('/admintag')
        page === 'Article' && navigate('/adminarticle')
  }
